...
function DrawerContent({
  ...
  const sizeClass = {
    ...
    lg: "sm:max-w-lg",
    xl: "sm:max-w-xl",
    full: "sm:max-w-none max-w-none",
  }[size];

  // Wide layout overrides width + max-width
  const wideClass = wide
    ? "data-[vaul-drawer-direction=right]:w-[92vw] md:data-[vaul-drawer-direction=right]:w-[85vw] lg:data-[vaul-drawer-direction=right]:w-[78vw] xl:data-[vaul-drawer-direction=right]:w-[72vw] data-[vaul-drawer-direction=right]:max-w-[1200px]"
    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          // right / left (no clamps, apply dynamic)
